...
define('api',[],function() {
  ...
  return HelpScoutAPI = (function() {
    function HelpScoutAPI(options) {
      ...
      this.base64AuthKey = btoa(this.apiKey + ':X');
      return this;
    }
    ...
    HelpScoutAPI.prototype._getRequestOptions = function(options) {
      ...
      return {
        url: [this.urlRoot, this.version, "" + options.resource + ".json"].join('/'),
        type: options.method,
        data: options.data,
        headers: {
...
define('conversations',['api'], function(HelpScoutAPI) {
...
define('main',['conversations', 'view'], function(HelpScout, WidgetView) {
  ...
  return Interface = (function() {
    ...
    Interface.prototype.init = function(options) {
      var onSubmit, view;
      ...
      view.onSubmit = onSubmit.bind(this);
